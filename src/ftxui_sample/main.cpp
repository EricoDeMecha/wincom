...
// configuration step. It creates a namespace called `wincom`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", wincom::cmake::project_name, wincom::cmake::project_version) };
